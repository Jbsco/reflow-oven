...
class TFT_eSPI_second : public Print { friend class TFT_eSprite; // Sprite class has access to protected members
...
/***************************************************************************************
**                         Section 9: TFT_eSPI_secondclass conditional extensions
***************************************************************************************/
...
#else
    #if !defined(DISABLE_ALL_LIBRARY_WARNINGS)
      #warning >>>>------>> TOUCH_CS pin not defined, TFT_eSPI_secondtouch functions will not be available!
    #endif
#endif
